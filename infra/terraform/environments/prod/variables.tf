...
variable "cloudfront_secret_header"{ type = string; sensitive = true }
variable "github_repo"             { type = string; description = "org/repo e.g. natanaeldev/lendStack" }
...
variable "web_min_count"           { type = number; default = 2 }
variable "web_max_count"           { type = number; default = 10 }
