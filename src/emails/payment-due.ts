/** Email sent to borrower on their payment due date. */
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08)">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#14532D 0%,#16A34A 100%);padding:28px 32px;text-align:center">
            <p style="margin:0;color:#bbf7d0;font-size:12px;font-weight:700;letter-spacing:2px;text-transform:uppercase">JVF Inversiones SRL</p>
        ...
        <tr>
          <td style="padding:32px">
            ...
            <p style="margin:0 0 24px;color:#6B7280;font-size:13px;line-height:1.6">
              Si ya realizaste el pago, por favor ignorá este mensaje. En caso de algún inconveniente, comunicáte con nosotros.
            </p>

            <p style="margin:0;color:#374151;font-size:14px">Saludos,<br><strong>Equipo JVF Inversiones SRL</strong></p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:16px 32px;text-align:center">
            <p style="margin:0;color:#94a3b8;font-size:11px">Este es un mensaje automático. Por favor no responda este correo.</p>
          </td>
        </tr>
