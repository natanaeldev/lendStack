...
<div class="grid">
  ...
  <div class="box" style="background:${config.colorBg}"><div class="box-label" style="color:${config.colorAccent}">Tasa anual</div><div class="box-val" style="color:${config.colorText}">${formatPercent(result.annualRate)}</div></div>
