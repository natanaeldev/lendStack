'use client'
import { LoanResult, RiskConfig, Currency, RateMode, formatCurrency, formatPercent } from '@/lib/loan'

interface Props { result: LoanResult; config: RiskConfig; currency: Currency; rateMode?: RateMode }
...
export default function ResultsPanel({ result, config, currency, rateMode = 'annual' }: Props) {
