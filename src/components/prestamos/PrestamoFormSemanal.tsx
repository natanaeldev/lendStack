...
export default function PrestamoFormSemanal({
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Interés y arranque" subtitle="Ajusta la tasa mensual equivalente y deja la fecha lista.">
        <Field label="Interés mensual (%)" hint="Se usa para calcular la cuota semanal.">
      ...
      <Section title="Notas operativas" subtitle="Agrega instrucciones para la ruta o el cobrador solo si son útiles.">
